...
<div class="dp-admin-nav-container" id="dp-tab1C">
    <div class="dp-tabs-content-wrap">
        <div class="dp-tabs-step">           
            ...
            <div class="dp-tabs-img"><img src="<?php echo esc_url(PLUGIN_URL . '/assets/images/download-plugin.png'); ?>" width="" height=""></div>
        </div>
        <div class="dp-tabs-step">           
            ...
            <div class="dp-tabs-img"><img src="<?php echo esc_url(PLUGIN_URL . '/assets/images/bulk-download-plugin.png'); ?>" width="" height=""></div>
        </div>
    </div>
</div>
<div class="dp-admin-nav-container" id="dp-tab2C">
    <div class="dp-tabs-content-wrap">
        <div class="dp-tabs-step">           
            ...
            <div class="dp-tabs-img"><img src="<?php echo esc_url(PLUGIN_URL . '/assets/images/multi-upload.png'); ?>" width="" height=""></div>
        </div>
    </div>
</div>